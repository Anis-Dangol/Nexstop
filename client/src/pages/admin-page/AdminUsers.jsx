...
function AdminUsers() {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-2 h-full flex flex-col">
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-2 space-y-3 lg:space-y-0 flex-shrink-0">
        <h1 className="text-2xl font-bold text-gray-700 ml-2">Users</h1>
      </div>
      {/* Combined Filters and Controls */}
      ...
      <div className="bg-gray-50 rounded-lg p-2 mb-2 flex-shrink-0">
        <h3 className="text-sm font-bold text-blue-800 uppercase tracking-wide border-b-2 border-blue-300 pb-1 mb-2 inline-block">
